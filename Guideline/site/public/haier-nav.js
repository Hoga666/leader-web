...
(function initHaierNavigation() {
  ...
  const PAGE_TITLE_EN = {
    ...
    'principles.html': 'Haier Design | Principles',
  ...
  sidebar.innerHTML = `
    <div class="relative p-8 pb-4">
      ...
      <a href="haier_os_design_system.html" class="haier-logo-container w-16 h-16 mb-4 text-xl shadow-md rounded-xl" aria-label="Haier Design 首页"><img src="assets/brand/haier-wordmark-white.png" alt="Haier"></a>
      <h1 class="text-2xl font-bold tracking-tight">Haier Design</h1>
      <p class="text-sm text-text-secondary mt-1">NEXT UX Guideline 1.0.0</p>
    </div>
